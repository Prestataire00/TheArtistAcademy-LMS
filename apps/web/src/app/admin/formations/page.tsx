          ...
          columns={[
            {
              ...
              render: (f) => (
                <div className="min-w-0">
                  <a href={`/admin/formations/${f.id}`} className="block font-medium text-gray-900 hover:text-brand-700 transition-colors truncate" title={f.title}>
                    {f.title}
                  </a>
                  {f.description && (
                    <p className="text-xs text-gray-400 truncate" title={f.description}>{f.description}</p>
                  )}
                </div>
              ),
            },
            {
              ...
              truncate: true,
              render: (f) => (
                <span className="text-xs text-gray-500" title={f.trainerName ?? undefined}>
                  {f.trainerName || <span className="text-gray-300">—</span>}
                </span>
              ),
            },
            {
              key: 'mode',
              mobileLabel: 'Mode',
              label: <SortableHeader field="pathwayMode" label="Mode" currentSort={t.sort} onSortChange={t.cycleSort} align="center" />,
              align: 'center',
              width: '95px',
              render: (f) => (
            ...
            },
            {
              key: 'modules',
              mobileLabel: 'Modules',
              label: <SortableHeader field="modulesCount" label="Modules" currentSort={t.sort} onSortChange={t.cycleSort} align="center" />,
              align: 'center',
              width: '85px',
            ...
            },
            {
              ...
              label: <SortableHeader field="enrollmentsCount" label="Inscrits" currentSort={t.sort} onSortChange={t.cycleSort} align="center" />,
              align: 'center',
              width: '85px',
            ...
            },
            {
              ...
              label: <SortableHeader field="createdAt" label="Créée" currentSort={t.sort} onSortChange={t.cycleSort} />,
              mobileHidden: true,
              width: '90px',
              render: (f) => (
            ...
            },
            {
              ...
              render: (f) => (
                <div className="flex items-center justify-end gap-1 whitespace-nowrap">
                  <a href={`/admin/formations/${f.id}`} className="p-1.5 text-brand-600 hover:text-brand-700 hover:bg-brand-50 rounded transition-colors" title="Gérer les modules">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <button onClick={() => handleDuplicate(f.id)} className="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded transition-colors" title="Dupliquer">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 011.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 00-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a1.125 1.125 0 01-1.125-1.125v-9.25" />
                    </svg>
                  </button>
                  <button onClick={() => handleDelete(f.id, f.title)} className="p-1.5 text-red-400 hover:text-red-600 hover:bg-red-50 rounded transition-colors" title="Supprimer">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
